...
<div class="jumbotron text-center">
  <div class="container">
    ...
    <a type="button" class="btn btn-lg btn-primary" href="https://github.com/infsci2560fa16/getting-started-on-heroku-with-java-liyuesong"><span class="glyphicon glyphicon-download"></span> Source on GitHub</a>
  </div>
</div>
<div class="container">
